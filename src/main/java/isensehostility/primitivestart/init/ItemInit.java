...
public class ItemInit {
    ...
    public static final RegistryObject<Item> REINFORCED_BONE_SWORD = ITEMS.register("reinforced_bone_sword", () -> new SwordItem(PrimitiveStart.COPPER, 3, -2.4F, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).stacksTo(1).durability(190)));
    public static final RegistryObject<Item> REINFORCED_BONE_PICKAXE = ITEMS.register("reinforced_bone_pickaxe", () -> new PickaxeItem(PrimitiveStart.COPPER, 1, -2.8F, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).durability(190)));
    public static final RegistryObject<Item> REINFORCED_BONE_AXE = ITEMS.register("reinforced_bone_axe", () -> new AxeItem(PrimitiveStart.COPPER, 6, -3.1F, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).durability(190)));
    public static final RegistryObject<Item> REINFORCED_BONE_SHOVEL = ITEMS.register("reinforced_bone_shovel", () -> new ShovelItem(PrimitiveStart.COPPER, 1.5F, -3.0F, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).durability(190)));
    public static final RegistryObject<Item> REINFORCED_BONE_HOE = ITEMS.register("reinforced_bone_hoe", () -> new HoeItem(PrimitiveStart.COPPER, -2, -1.0F, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).durability(190)));
    ...
    public static final RegistryObject<Item> PLATED_BONE_SWORD = ITEMS.register("plated_bone_sword", () -> new SwordItem(PrimitiveStart.PLATED, 3, -2.4F, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).stacksTo(1).durability(200)));
    public static final RegistryObject<Item> PLATED_BONE_PICKAXE = ITEMS.register("plated_bone_pickaxe", () -> new PickaxeItem(PrimitiveStart.PLATED, 1, -2.8F, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).durability(200)));
    public static final RegistryObject<Item> PLATED_BONE_AXE = ITEMS.register("plated_bone_axe", () -> new AxeItem(PrimitiveStart.PLATED, 6, -3.1F, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).durability(200)));
    public static final RegistryObject<Item> PLATED_BONE_SHOVEL = ITEMS.register("plated_bone_shovel", () -> new ShovelItem(PrimitiveStart.PLATED, 1.5F, -3.0F, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).durability(200)));
    public static final RegistryObject<Item> PLATED_BONE_HOE = ITEMS.register("plated_bone_hoe", () -> new HoeItem(PrimitiveStart.PLATED, -2, -1.0F, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).durability(200)));
